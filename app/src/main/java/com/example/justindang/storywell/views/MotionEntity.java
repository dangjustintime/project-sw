...
import com.example.justindang.storywell.model.Layer;
import com.example.justindang.storywell.utilities.MathUtilities;
...
public abstract class MotionEntity {
    ...
    public boolean pointInLayerRect(PointF point) {
        ...
        return MathUtilities.pointInTriangle(point, pA, pB, pC) || MathUtilities.pointInTriangle(point, pA, pD, pC);
    }
